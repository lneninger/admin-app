...
@AutoUnsubscribe()
@Component({
  selector: 'app-settings-subscription-fail',
  templateUrl: './subscription-fail.component.html',
  styleUrls: ['./subscription-fail.component.scss']
})
export class SettingsSubscriptionFailComponent extends BaseComponent implements OnInit {
